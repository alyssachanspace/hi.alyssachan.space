...
| CSS 屬性 | 說明 | 值 |
| --- | --- | --- |
| [`background`](https://developer.mozilla.org/en-US/docs/Web/CSS/background) | 背景 | 屬性有<br> * [`background-color`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-color) 背景色<br>* [`background-position`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-position) 背景位置<br> * [`background-repeat`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-repeat) 背景重複<br> * [`background-size`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-size) 背景尺寸：`cover` 完全覆蓋（可能被裁）、 `contain` 全幅（可能有空白）、長度或百分比<br> * [`background-image`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-image) 背景圖<br> * [`background-origin`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-origin) 背景圖相對區域<br> * [`background-attachment`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-attachment) 背景固定或滾動<br> *  [`background-clip`](https://developer.mozilla.org/en-US/docs/Web/CSS/background-clip) 背景延伸<br>例：`center / contain no-repeat url("圖片網址")` 置中 全幅 不重複 背景圖 |
...
| [`position`](https://developer.mozilla.org/en-US/docs/Web/CSS/position) | 定位 | <p>* `static` 正常佈局<br>* `relative` 相對定位<br> * `absolute` 絕對定位，以上一個相對定位為原點<br> * `fixed` 固定定位，以視窗為原點<br> * `sticky` 粘性定位</p> |
